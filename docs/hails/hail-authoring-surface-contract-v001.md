# Hail Authoring Surface Contract (HASC) v001

**Status:** **Locked** — single index for Forge + Hails authoring preview and controls.  
**Praxis:** `pso-20260614-axiom-hail-authoring-surface-contract` · `pso-20260619-axiom-paintbox-parity-standards-alignment`  
**Id:** `hail-authoring-surface-contract-v001`
